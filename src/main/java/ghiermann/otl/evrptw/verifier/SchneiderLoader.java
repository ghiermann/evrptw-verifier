...
import ghiermann.otl.evrptw.verifier.EVRPTWInstance.BEVehicleType;
import ghiermann.otl.evrptw.verifier.EVRPTWInstance.Customer;
import ghiermann.otl.evrptw.verifier.EVRPTWInstance.Depot;
import ghiermann.otl.evrptw.verifier.EVRPTWInstance.RechargingStation;
...
public class SchneiderLoader {
    ...
    EVRPTWInstance load(File file) throws FileNotFoundException, IOException {
        ...
        return new EVRPTWInstance(file.getName(), depots.get(0), rcstations, customers, vType);
    }
